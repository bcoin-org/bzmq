...
Object.setPrototypeOf(ZMQ.prototype, EventEmitter.prototype);
...
ZMQ.prototype.open = async function open() {
  this.sockets.open();
  this.closed = false;
  this.logger.info('ZeroMQ loaded.');
};

ZMQ.prototype.close = async function close() {
  this.sockets.close();
  this.closed = true;
};
...
Sockets.prototype.add = function add(topic, addr) {
